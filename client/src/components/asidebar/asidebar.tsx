  ...
  return (
    <>
      <Sidebar collapsible="icon">
        <SidebarHeader className="!py-0 bg-sidebar dark:bg-background">
        ...
        <SidebarContent className=" !mt-0 bg-sidebar dark:bg-background">
        ...
        <SidebarFooter className="bg-sidebar dark:bg-background">
          <SidebarMenu>
            <SidebarMenuItem>
              {isLoading ? (
                <Loader
